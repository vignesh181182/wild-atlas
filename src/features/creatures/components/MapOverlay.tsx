...
import { MAP_WIDTH } from '@/features/creatures/server/world-land';
import { RangeMap, WHOLE_WORLD, fitToSightings, type ViewBox } from '@/features/creatures/components/RangeMap';
import { CloseIcon, FitIcon, GlobeIcon } from '@/components/icons';
